  	...
  	<div class="container px-4 py-5 faq-container">
	      ...
	      <div class="col-lg-4 mt-3">
	      	<div class="card h-100 p-5 border-0 shadow rounded-4 card-faq wow fadeInUp">
		        ...
		        <p class="description-text-faq">
		        	 {{ __('Online voting for Lakan, Lakambini at Lakandyosa 2024 will conclude on September 02, 2024, at 12:59 PM. Please note that the system will no longer accept any further votes after this specified deadline.') }}
		      	</p>
	      	</div>
	      </div>
	      <div class="col-lg-4 mt-3">
