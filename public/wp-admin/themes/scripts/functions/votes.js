...
const getAllVotes = async () => {
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/get/all`,
		method: 'get',
		dataType: 'json',
...
const loadMoreVotesRecord = async (limit, offset) => {
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/load/${limit}/offset/${offset}`,
		method: 'get',
		dataType: 'json',
		headers: { 'X-CSRF-TOKEN': CSRF_TOKEN },
		success: (data) => {
...
const getOneVotes = async (votesId) => {
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/${votesId}/get`,
		method: 'get',
		dataType: 'json',
		headers: { 'X-CSRF-TOKEN': CSRF_TOKEN },
		success: (data) => {
...
const countAllVotes = async () => {
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/count/all`,
		method: 'get',
		dataType: 'json',
		headers: { 'X-CSRF-TOKEN': CSRF_TOKEN },
		success: (counted) => {
...
const filterVotesByStatus = async (status) => {
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/get/all/${status}/status`,
		method: 'get',
		dataType: 'json',
...
const filterVotesBySearch = async (search) => {
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/get/all/${search}/search`,
		method: 'get',
		dataType: 'json',
		headers: { 'X-CSRF-TOKEN': VOTES_URI },
		success: (data) => {
...
const createNewVote = async (dataForm) => {
	runSpinner();
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/store`,
		method: 'post',
		data: dataForm,
		dataType: 'json',
		headers: { 'X-CSRF-TOKEN': CSRF_TOKEN },
...
const updateVotes = async (dataForm) => {
	runSpinner();
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/update`,
		method: 'patch',
		data: dataForm,
		dataType: 'json',
		headers: { 'X-CSRF-TOKEN': CSRF_TOKEN },
...
const updateVotesByStatus = async (votesId, status) => {
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/update/status`,
		method: 'patch',
		data: { 
			'vid': votesId, 
			'status': status 
...
const deleteVotes = async (votesId) => {
	$.ajax({
		url: `/${APP_VERSION}/${VOTES_URI}/${votesId}/destroy`,
		method: 'delete',
		dataType: 'json',
		headers: { 'X-CSRF-TOKEN': CSRF_TOKEN },
		success: (response) => {
			if(response.success) {
				$(`.votesItem_${votesId}`).remove();
				getAllVotes();
				countAllVotes();
				toastr.success(response.message);
			} else {
